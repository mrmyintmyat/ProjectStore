            ...
            <aside id="nav" class="p-0 d-flex justify-content-center align-items-center fixed-top bg-white ">
                <nav class="navbar navbar-expand-lg w-100 d-flex container-lg px-2">
                    ...
                    @if (request()->is('/'))
                        ...
                        <a class="navbar-brand fw-semibold d-lg-none ms-2 d-block"
                            href="/">{{ env('APP_NAME') }}</a>
                    @endif
                    @if (!request()->is('/'))
                    ...
                    <div class="collapse navbar-collapse justify-content-lg-end" id="navbarNavDropdown">
                        <ul class="navbar-nav g-3">
                            <li class="nav-item ms-2">
                                <a href="/"
                                    class="text-decoration-none d-flex align-items-center nav-link py-2 @if (request()->is('/')) active @endif">
                            ...
                            @if (Auth::check())
                                ...
                                <li class="nav-item ms-2 text-center">
                                    <a href="/my-orders"
                                        class="text-decoration-none d-flex align-items-center nav-link py-2  @if (request()->is('my-orders')) active @endif">
                                ...
                                <li class="nav-item ms-2 text-center">
                                    <a href="/profile"
                                        class="text-decoration-none d-flex align-items-center nav-link py-2  @if (request()->is('profile')) active @endif">
                                ...
                                <li class="nav-item ms-2 text-center">
                                    <a href="/notice"
                                        class="text-decoration-none d-flex align-items-center nav-link py-2  @if (request()->is('notice')) active @endif">
                                        @if (Auth::check())
                                            @php
                                                $user = Auth::user();
                                                $notices_check = $user
                            ...
                            @if (!Auth::check())
                                <li class="nav-item ms-2 text-center">
                                    <a href="/register"
                                        class="text-decoration-none d-flex align-items-center nav-link py-2  @if (request()->is('register')) active @endif">
