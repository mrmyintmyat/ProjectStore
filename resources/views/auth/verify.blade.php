...
<div class="container">
    <div class="loginBox">
        <h3 class="fs-2 fw-bold">Verify Email</h3>
        ...
        <form action="{{ route('verify_email') }}" method="post">
            @csrf
            <div class="inputBox">
                <input id="verification_code" type="text" class="@error('verification_code') is-invalid @enderror" name="verification_code" required autofocus placeholder="Verify Code">
            </div>
    ...
    {{-- <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('verification.verify_email') }}">
                        @csrf
